...
- Unused voiceover lines "Shutdown initiated" (CVM_0037.WAV) and "Powerup initiated. Internal damage 
  detected." (CVM_0036.WAV) suggest that Dynamix considered mid-mission shutdown - a feature that
  was later implemented for stealth purposes in *Starsiege*.
