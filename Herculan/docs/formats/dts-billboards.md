...
**Vertical squash.** Before projecting, the same axis's length surviving in the view plane is measured (`Vec2_DistanceBetween` on the view-space x/z pair, range `0..0x800`). The drawn height is
