...
| 5 | varies | the player: `int16` squad positions in play (`00482a78`), `int16` machines on strength (`00482a7a`), then one pilot record — **the same shape as a squadmate's**, roster id included | `FUN_0041016d` / `FUN_004101b8` |
...
| `+0x27` | `int16` | squad position, 1-3 — the crew screen row the pilot fills ([`../shell/screen-layout.md`](../shell/screen-layout.md#the-rows)); initialized `-1`. Selects the promotion divisors in `FUN_00410066` |
