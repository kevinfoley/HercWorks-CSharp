...
The count in a registration is the **destination array's capacity, not the group's size** — group 23 is registered with 40 slots for 31 strings. Only the order is load-bearing.
