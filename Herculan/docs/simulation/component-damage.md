...
## Open
- Exact sub-piece breakdown per component
- The salvage pass ([above](#what-a-wreck-is-worth--mech_salvagevalue-00418e60)) and with it `mech+0xb3`, and `Mech_ReportOutOfAction`'s mission-variable writes.