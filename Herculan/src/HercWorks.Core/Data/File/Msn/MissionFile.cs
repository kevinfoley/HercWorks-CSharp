...
public class MissionFile : DataFile {
	...
	public SpawnRecord144[]? SpawnRecords { get; set; }
	...
	public UnkEntity164Bytes[]? Entities164 { get; set; }
	...
	/// </summary>
	public LinkedRef58?[]? LinkedRefs58 { get; set; }
	...
	public Flag10? GetFlag(short guid) => FindByGuid(Flags, guid);
	...
	public SpawnRecord144? GetSpawnRecord(short guid) => FindByGuid(SpawnRecords, guid);
	...
	public UnkEntity164Bytes? GetEntity164(short guid) => FindByGuid(Entities164, guid);
