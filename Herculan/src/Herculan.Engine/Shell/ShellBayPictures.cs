...
/// <c>FUN_00414e5b</c> from <c>gam\arm_*.dat</c> into the eight bay pictures <c>Squad_BuildRosterList</c>
...
public sealed class ShellBayPictures {
	/// <summary>
	/// Where <c>FUN_00414e5b</c> puts the eight bay pictures: moved to <c>{5, 0x2b}</c> and sized
	...
	/// <summary>
	/// <c>FUN_00413ccc</c> over the arming layout — the record in the fitted weapon's group whose id is
