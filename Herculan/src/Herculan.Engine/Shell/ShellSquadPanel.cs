...
/// (<c>0043cfe7</c>), its readout filled by <c>FUN_0043d38a</c> and its rows by <c>FUN_0043da47</c>
/// and <c>FUN_0043dad7</c>. The rects are literals in the canvas. See docs/shell/screen-layout.md,
/// "The squad panel".
///
...
///
/// <para><b>Each tab takes a roster click its own way</b>, all inside <c>FUN_0043d64d</c>.
...
public static class ShellSquadPanel {
	...
	/// <summary>
	/// <c>FUN_0043d64d</c>'s crew-tab arm: no bay at all, or a bay holding a finished machine — and not
